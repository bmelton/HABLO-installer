...
0. **Fresh machine?** First the AWS profile (README, "Before you run it"): `aws configure sso --profile bedrouter`, then `./install.sh --install-pi --profile bedrouter --ladder oss`. The rest of this list assumes that has run.
